...
class UserTest < ActiveSupport::TestCase
	...
	# Test uniqueness of screen_name and email
	...
	# Test screen name length boundaries
	...
	# Test the screen name with valid examples
	...
	# Test the screen name with invalid examples
