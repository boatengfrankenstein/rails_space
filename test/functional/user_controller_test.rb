...
#	end
	...
	# Test with remember_me box checked
	...
	# Test a login with an invalid screen name
	def test_login_failure_with_nonexistent_screen_name
		...
		# Make sure the screen name will be redisplayed, but not the password
		user = assigns(:user)
		assert_equal invalid_user.screen_name, user.screen_name
		assert_nil user.password
	end
	
	# Test a login with an invalid password
